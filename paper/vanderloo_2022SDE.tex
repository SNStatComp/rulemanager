...
detail. It also promotes a modular architecure where building a production
system in principle amounts to assembling a set of prebuilt modules for
different business functions and parameterizing them with business logic for
the system at  hand.
...
integration of production systems accross institutes naturally leads to the
...
possibility of comparing rule sets accross production systems. 
...
\paragraph There are also user stories from the perspectif of a statistical organisation.
...
\paragraph To save space, we choose an appraoch that is more natural to
